# USAGE
# python create_gif.py --config config.json --image images/photo-001.jpg --output images/meme-001.gif
# python create_gif.py --config config.json --image images/photo-002.jpg --output images/meme-002.gif
# python create_gif.py --config config.json --image images/jordi.jpg --output images/meme-003.gif
...
def create_gif(inputPath, outputPath, delay, finalDelay, loop):
	...
	# frame (if so desired)
	cmd = "magick convert -delay {} {} -delay {} {} -loop {} {}".format(
